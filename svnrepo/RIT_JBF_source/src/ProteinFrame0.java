...
public class ProteinFrame0 extends JFrame {
    ...
    private BlastSearch blstSearch; //button clicked to search Blast site
     ...
     */
    public ProteinFrame0(Electro2D e, String pt, int filenum) {
        ...
        blstSearch = new BlastSearch( electro2D, sequenceString, oneText);
        ...
        if( proteinTitle.indexOf( "|" ) < 0 ){
            ...
            swsSearch = new SwissProtSearch( electro2D, swsSearchID, threeText);
        }
        else {
