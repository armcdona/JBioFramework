...
/**
 * Electro2D.GIFEncoder is a class which takes an image and saves it to a stream
 * using the GIF file format (<A
 * HREF="http://www.dcs.ed.ac.uk/%7Emxr/gfx/">Graphics Interchange
 * Format</A>). A Electro2D.GIFEncoder
 ...
 * Three caveats:
 * <UL>
 *   <LI>Electro2D.GIFEncoder will convert the image to indexed color upon
 ...
 *   Electro2D.GIFEncoder may have problems with large images. Attempting to
 ...
 * </UL><P>
 *
 * Electro2D.GIFEncoder is based upon gifsave.c, which was written and released
 * by:<P>
 * <CENTER>
 *                                  Sverre H. Huseby<BR>
 *                                   Bjoelsengt. 17<BR>
...
public class GIFEncoder {
    ...
    /**
     * Construct a Electro2D.GIFEncoder. The constructor will convert the image to
