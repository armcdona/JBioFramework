...
public class SpecAminoAcid {
    ...
    /**
     * Constructor for MassSpec.SpecAminoAcid when given a String instead of a char. Turns
     * input into a char and passes to translate method.
     *
     * @param input Symbol to be turned in to an MassSpec.SpecAminoAcid.
     * @throws AminoException When given a symbol that doesn't represent an
     ...
     * of MassSpec.SpecAminoAcid based on the symbol given.
     *
     * @param code Symbol to be turned in to an MassSpec.SpecAminoAcid.
    ...
    /**
     * Used only by MassSpec.SpecAminoAcid in translate. Sets the name variable.
     *
     * @param n Name.
     */
    ...
    /**
     * Used only by MassSpec.SpecAminoAcid in translate. Sets the mass variable.
     *
     * @param m Mass.
     */
    ...
    /**
     * Used only by MassSpec.SpecAminoAcid in translate. Sets the charge variable.
     *
     * @param c Charge.
     */
    ...
    /**
     * Used by MassSpec.Spectrometer when determining the right intensity to use for
    ...
    /**
     * Used by MassSpec.Spectrometer to increase the charge of the MassSpec.SpecAminoAcid when it is
     * being used in the TandemOutputGUI (to make sure each MassSpec.SpecAminoAcid has a charge
     * of at least 1).
     */
    ...
    /**
     * Used to return the MassSpec.SpecAminoAcid's name.
     *
     * @return Name.
     */
    ...
    /**
     * Used to return the MassSpec.SpecAminoAcid's mass.
     *
     * @return Mass.
     */
    ...
    /**
     * Used to return the MassSpec.SpecAminoAcid's charge.
     *
     * @return Charge.
     */
    ...
    /**
     * Used to return the MassSpec.SpecAminoAcid's mass charge ratio when being used in
     * TandemOutputGUI.
     *
